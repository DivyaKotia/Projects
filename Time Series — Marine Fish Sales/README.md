...
**Step 1 — Digitization and Aggregation**
Handwritted sales data written in regional language was digitized and converted into monthly sales data.
...
Multiplicative seasonality identified in the sales pattern. SARIMA(2,1,3)(0,1,1,12) fitted to capture the seasonal component the baseline ARIMA could not.
